 ...
 * Populates Payload with the current page content so it's editable via /admin.
 */
...
async function seed() {
      ...
      sections: [
        ...
        },
        {
          ...
          steps: [
            ...
            { num: '02', title: 'WE MAKEN EEN PLAN.', description: 'We vertalen jouw doelen naar een praktische digitale route. Realistisch waar nodig. Ambitieus waar het kan. Geen dikke rapporten, wel een concreet groeiplan.', side: 'left' },
            { num: '03', title: 'WE BOUWEN JE FUNDAMENT.', description: 'Geen standaard website die over twee jaar weer vervangen moet worden. We bouwen een snel, veilig en schaalbaar digitaal fundament dat kan meegroeien met jouw verhuurbedrijf.', side: 'right' },
            ...
            { num: '06', title: 'WE BLIJVEN MEEDENKEN.', description: 'Geen project opleveren en verdwijnen. Rent Harder blijft je digitale sidekick. We kijken mee, verbeteren wat beter kan en zien nieuwe kansen voordat ze blijven liggen.', side: 'left' },
          ],
        },
        {
          ...
          description: 'Kijk wat er ontstaat wanneer ambitieuze verhuurbedrijven en Rent Harder naast elkaar gaan staan. Van scherpere positionering tot meer zichtbaarheid, betere focus en een sterkere digitale basis.',
          cases: [
            {
              name: 'JH VERHUUR',
              transformation: [{ text: 'Van breed verhaal' }, { text: 'naar scherpe containerfocus.' }],
              points: [{ text: 'Eigen containerpropositie' }, { text: 'Duidelijkere doelgroep' }, { text: 'Betere lokale vindbaarheid' }],
              featured: false,
            },
            {
              name: 'FLEXPUMPS',
              transformation: [{ text: 'Van pompen verhuren' }, { text: 'naar een merk dat niemand mist.' }],
              points: [{ text: 'Sterke positionering' }, { text: 'Opvallende content' }, { text: 'Krachtige digitale basis' }],
              featured: true,
            },
            {
              name: 'MEIJER VERHUUR',
              transformation: [{ text: 'Van lokaal verhuurbedrijf' }, { text: 'naar regionale autoriteit.' }],
              points: [{ text: 'Meer focus op verhuurtak' }, { text: 'Digitale groei strategie' }, { text: 'Meer online aanvragen' }],
              featured: false,
            },
          ],
          ctaText: 'MEER BUILDS',
  ...
  // ─── HOOGWERKER PAGE ─────────────────────────────────────────────────────
  const hoogwerkerPage = await payload.create({
    collection: 'pages',
    data: {
      ...
      sections: [
        ...
        },
        {
          ...
          highlights: [
            { text: 'Regio Oost-Groningen' },
            { text: 'Hoogwerkers + materieel' },
            { text: 'Digitale verhuurtak' },
          ],
          description: 'Meijer Verhuur had het materieel, de kennis en de klanten. Maar digitaal was er weinig zichtbaar. Samen bouwden we een compleet digitaal fundament.',
          bulletPoints: [
            { text: 'Eigen verhuurplatform met assortiment' },
            { text: 'Lokale vindbaarheid in Google' },
            { text: 'Professionele content en fotografie' },
            { text: 'Meer aanvragen uit de regio' },
          ],
        ...
        },
        {
          ...
          steps: [
            ...
            { num: '03', title: 'KLANT', description: 'We zorgen dat de juiste klant jou vindt op het moment dat hij zoekt. Geen ruis. Geen omwegen.' },
          ],
        },
        {
  ...
  console.log('✅ Hoogwerkerverhuur page created:', hoogwerkerPage.id)
  ...
  for (const ep of episodesData) {
    await payload.create({
      ...
      data: { ...ep, published: true },
    })
  }
  console.log('✅ TV Episodes seeded (4)')
  ...
  await payload.updateGlobal({
    ...
    data: {
      ...
      footer: {
        tagline: 'De digitale sidekick achter jouw verhuur.',
        description: 'Jij verhuurt het materieel.',
        descriptionBold: 'Wij bouwen en ontwikkelen jouw complete digitale verhuurtak.',
  ...
  console.log('\n🎉 Seeding complete! Visit /admin to manage content.')
  process.exit(0)
}
